  ...
  <div>
    <el-form ref="form" :model="serverCfg" label-width="120px">
      ...
      <el-form-item label="目标地址">
        <el-input v-model="serverCfg.proxy"></el-input>
      </el-form-item>
      <el-form-item label="域名白名单">
        <el-input v-model="serverCfg.origin"></el-input>
      ...
      <el-form-item label="自定义请求头">
        <el-input v-model="serverCfg.header"></el-input>
        <div class="tip-info" style="margin-top: 12px;">
          <ul>
            <li>允许的请求头,字符串</li>
            <li>一般用于标识用于登录状态，多个请求头之间用英文逗号分隔。如'token','token,authorization'</li>
          </ul>
        </div>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async onSave () {
      ...
      await this.$ajax('saveServe', saveStatus)
      this.$alert('保存成功', '提示')
    }
  }
}
